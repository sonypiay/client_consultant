  ...
  <div>
    <div class="uk-card uk-card-default uk-card-body card-panel">
      ...
      <form class="uk-form-stacked uk-margin-top" @submit.prevent="saveProfile">
        ...
        <div class="uk-margin">
          <label class="uk-form-label gl-label">No. Telepon / Whatsapp</label>
          <div class="uk-form-controls">
        ...
        <div class="uk-margin">
          <label class="uk-form-label gl-label">NPWP</label>
          <div class="uk-form-controls">
            <input type="tel" v-model="forms.npwp" class="uk-input gl-input-default" />
          </div>
          <div v-show="messages.errors.npwp" class="uk-text-danger uk-text-small">{{ messages.errors.npwp }}</div>
        </div>
        <div class="uk-margin">
          <label class="uk-form-label gl-label">Tipe Client</label>
          <div class="uk-form-controls">
            <label><input class="uk-radio" type="radio" v-model="forms.type" value="perorangan" :checked="forms.type === 'perorangan'" /> Individual</label>
            <label class="uk-margin-left"><input class="uk-radio" type="radio" v-model="forms.type" value="pt" :checked="forms.type === 'pt'" /> Company</label>
          </div>
        </div>
        <div class="uk-margin">
