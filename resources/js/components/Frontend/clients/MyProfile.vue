    ...
    <div class="uk-container uk-margin-large-bottom container-editprofile">
      <div class="uk-width-2-5@xl uk-width-2-5@l uk-width-1-2@m uk-width-1-1@s uk-align-center uk-card uk-card-body uk-card-default card-panel">
        ...
        <div class="uk-panel uk-margin">
          ...
          <p class="uk-text-muted uk-margin-remove-top">
            {{ getuser.client_address }}
          </p>
        </div>
        <div class="uk-panel uk-margin">
          <h4 class="uk-h4 uk-margin-remove-bottom">Tipe</h4>
          <p class="uk-text-muted uk-margin-remove-top">
            <span v-if="getuser.client_type === 'pt'">Perusahaan</span>
            <span v-else>Perorangan</span>
          </p>
        </div>
        <a :href="$root.url + '/client/edit_profile'" class="uk-width-1-1 uk-button uk-button-default gl-button-default"><span uk-icon="icon: pencil; ratio: 0.7"></span> Ubah Profil</a>
      </div>
    </div>
  </div>
</template>
