          ...
          <div class="uk-navbar-right">
            <ul v-if="haslogin.isLogin === true && haslogin.user === 'client'" class="uk-navbar-nav navhomepage">
              ...
              <li>
                ...
                <div class="uk-navbar-dropdown uk-width-1-5 navbar-dropdown-homepage" uk-dropdown="mode: click;">
            ...
            <ul v-else-if="haslogin.isLogin === true && haslogin.user === 'consultant'" class="uk-navbar-nav navhomepage">
              <li>
                <a href="#">
                  <span uk-icon="bell"></span>
                  <span v-show="getnotification.total !== 0" class="count-notification">{{ getnotification.total }}</span>
