...
CREATE TABLE `conversation_chat` (
  ...
  PRIMARY KEY (`chat_id`),
  UNIQUE KEY `seqid` (`seqid`),
  KEY `fk_chat_client_id` (`client_id`),
  KEY `fk_chat_consultant_id` (`consultant_id`),
  CONSTRAINT `fk_chat_client_id` FOREIGN KEY (`client_id`) REFERENCES `client_user` (`client_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_chat_consultant_id` FOREIGN KEY (`consultant_id`) REFERENCES `consultant_user` (`consultant_id`) ON DELETE CASCADE
...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `fk_chat_id` FOREIGN KEY (`chat_id`) REFERENCES `conversation_chat` (`chat_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
insert  into `notification`(`id`,`user_id`,`notif_message`,`parent_id`,`notif_read`,`notif_date`) values (1,'CLT0001','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180001','APT1911180001','R','2019-11-18 15:44:58'),(2,'CLT0002','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180001','APT1911180001','R','2019-11-18 15:44:58'),(3,'CLT0003','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180001','APT1911180001','N','2019-11-18 15:44:58'),(4,NULL,'Konsultasi dengan nomor APT1911180001 diterima','APT1911180001','N','2019-11-18 16:16:14'),(5,'CLT0001','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180002','APT1911180002','R','2019-11-18 17:09:16'),(6,'CLT0002','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180002','APT1911180002','R','2019-11-18 17:09:16'),(7,'CLT0003','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180002','APT1911180002','N','2019-11-18 17:09:16'),(8,'CLT0001','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180003','APT1911180003','R','2019-11-18 17:10:03'),(9,'CLT0002','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180003','APT1911180003','R','2019-11-18 17:10:03'),(10,'CLT0003','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180003','APT1911180003','N','2019-11-18 17:10:03'),(11,'CL0001','Konsultasi dengan nomor APT1911180003 diterima','APT1911180003','R','2019-11-18 17:13:10'),(12,'CL0001','Konsultasi dengan nomor APT1911180002 diterima','APT1911180002','R','2019-11-18 17:13:15'),(13,'CLT0001','Konsultasi dengan nomor APT1911180002 sudah terpecahkan','APT1911180002','R','2019-11-18 19:53:45'),(14,'CLT0001','Konsultasi dengan nomor APT1911180003 sudah terpecahkan','APT1911180003','R','2019-11-18 19:53:51'),(15,'CLT0001','Konsultasi dengan nomor APT1911180002 sudah selesai','APT1911180002','R','2019-11-18 20:01:36'),(16,'CL0001','Konsultasi dengan nomor APT1911180002 sudah selesai','APT1911180002','R','2019-11-18 20:01:36'),(17,'CLT0001','Konsultasi dengan nomor APT1911180003 sudah selesai','APT1911180003','R','2019-11-18 20:01:46'),(18,'CL0001','Konsultasi dengan nomor APT1911180003 sudah selesai','APT1911180003','R','2019-11-18 20:01:46'),(19,'CLT0002','Konsultasi dengan nomor APT1911180001 sudah terpecahkan','APT1911180001','R','2019-11-18 20:11:32'),(20,'CL0001','Konsultasi dengan nomor APT1911180001 sudah terpecahkan','APT1911180001','R','2019-11-18 20:11:32'),(21,'CLT0002','Konsultasi dengan nomor APT1911180001 sudah selesai','APT1911180001','R','2019-11-18 20:12:18'),(22,'CL0001','Konsultasi dengan nomor APT1911180001 sudah selesai','APT1911180001','R','2019-11-18 20:12:18'),(23,'CL0001','Anda menerima jadwal undangan konsultasi dengan nomor ID APT1911180004','APT1911180004','R','2019-11-18 20:13:34'),(24,'CLT0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:23:54'),(25,'CL0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:23:54'),(26,'CL0001','Jadwal konsultasi APT1911180004 telah diganti.','APT1911180004','R','2019-11-18 20:24:15'),(27,'CLT0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:29:53'),(28,'CL0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:29:53'),(29,'CLT0001','Jadwal konsultasi APT1911180004 telah diganti.','APT1911180004','R','2019-11-18 20:37:42'),(30,'CLT0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:39:28'),(31,'CL0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:39:28'),(32,'CL0001','Jadwal konsultasi APT1911180004 telah diganti.','APT1911180004','R','2019-11-18 20:39:50'),(33,'CLT0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:46:03'),(34,'CL0001','Konsultasi dengan nomor APT1911180004 ditolak','APT1911180004','R','2019-11-18 20:46:03'),(35,'CL0001','Jadwal konsultasi APT1911180004 telah diganti.','APT1911180004','R','2019-11-18 20:47:06'),(36,'CLT0001','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180004','APT1911180004','R','2019-11-18 20:48:46'),(37,'CLT0002','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180004','APT1911180004','R','2019-11-18 20:48:46'),(38,'CLT0003','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911180004','APT1911180004','N','2019-11-18 20:48:46'),(39,'CLT0001','Konsultasi dengan nomor APT1911180004 diterima','APT1911180004','R','2019-11-18 20:53:35'),(40,'CL0001','Konsultasi dengan nomor APT1911180004 diterima','APT1911180004','R','2019-11-18 20:53:35'),(41,'CLT0001','Konsultasi dengan nomor APT1911180004 belum terpecahkan','APT1911180004','R','2019-11-18 20:54:16'),(42,'CL0001','Konsultasi dengan nomor APT1911180004 belum terpecahkan','APT1911180004','R','2019-11-18 20:54:16'),(43,'CL0001','Jadwal konsultasi APT1911180004 telah diganti.','APT1911180004','R','2019-11-18 20:54:28'),(44,'CLT0001','Konsultasi dengan nomor APT1911180004 diterima','APT1911180004','R','2019-11-18 20:55:42'),(45,'CL0001','Konsultasi dengan nomor APT1911180004 diterima','APT1911180004','R','2019-11-18 20:55:42'),(46,'CLT0001','Konsultasi dengan nomor APT1911180004 sudah terpecahkan','APT1911180004','R','2019-11-18 20:57:14'),(47,'CL0001','Konsultasi dengan nomor APT1911180004 sudah terpecahkan','APT1911180004','R','2019-11-18 20:57:14'),(48,'CLT0001','Konsultasi dengan nomor APT1911180004 sudah selesai','APT1911180004','R','2019-11-18 20:58:04'),(49,'CL0001','Konsultasi dengan nomor APT1911180004 sudah selesai','APT1911180004','R','2019-11-18 20:58:04'),(50,'CLT0001','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911190006','APT1911190006','R','2019-11-19 15:01:37'),(51,'CLT0002','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911190006','APT1911190006','R','2019-11-19 15:01:37'),(52,'CLT0003','Klien mengajukan permintaan konsultasi dengan nomor ID APT1911190006','APT1911190006','N','2019-11-19 15:01:37'),(53,'CLT0001','Konsultasi dengan nomor APT1911190006 diterima','APT1911190006','R','2019-11-19 15:02:43'),(54,'CL0001','Konsultasi dengan nomor APT1911190006 diterima','APT1911190006','R','2019-11-19 15:02:43'),(55,'CL0001','Anda menerima jadwal undangan konsultasi dengan nomor ID APT1911190007','APT1911190007','R','2019-11-19 16:40:13'),(56,'CLT0002','Konsultasi dengan nomor APT1911190007 diterima','APT1911190007','R','2019-11-19 16:48:59'),(57,'CL0001','Konsultasi dengan nomor APT1911190007 diterima','APT1911190007','R','2019-11-19 16:48:59'),(58,'CLT0002','Konsultasi dengan nomor APT1911190007 sudah terpecahkan','APT1911190007','R','2019-11-20 02:21:15'),(59,'CL0001','Konsultasi dengan nomor APT1911190007 sudah terpecahkan','APT1911190007','R','2019-11-20 02:21:15'),(60,'CLT0002','Konsultasi dengan nomor APT1911190007 sudah selesai','APT1911190007','R','2019-11-20 02:22:23'),(61,'CL0001','Konsultasi dengan nomor APT1911190007 sudah selesai','APT1911190007','R','2019-11-20 02:22:23'),(62,'CL0001','Anda menerima jadwal undangan konsultasi dengan nomor ID APT1911200008','APT1911200008','R','2019-11-20 03:11:26'),(63,'CL0001','Anda menerima jadwal undangan konsultasi dengan nomor ID APT1911230008','APT1911230008','R','2019-11-23 19:32:38');
